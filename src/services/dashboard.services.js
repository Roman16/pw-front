...
export const startDateFormatting = (date) => date === 'lifetime' ? 'lifetime' : moment.tz(`${moment(date).format('YYYY-MM-DD')} ${moment().startOf('day').format('HH:mm:ss')}`, 'America/Los_Angeles').toISOString()
export const endDateFormatting = (date) => date === 'lifetime' ? 'lifetime' : moment.tz(`${moment(date).format('YYYY-MM-DD')} ${moment().endOf('day').format('HH:mm:ss')}`, 'America/Los_Angeles').toISOString()
