...
function getProductsSettingsList({size, page, searchStr='', isActive}) {
    return api('get', `${productsUrls.productsSettingsList}?search_query=${searchStr}&page=${page}&size=${size}&isActive=${isActive ? 1 : 0}`)
}
