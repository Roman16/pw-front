            ...
            <div className="container">
                ...
                <div className="page-description">
                    ...
                    <div className="social">
                        ...
                        <a
                            href="https://www.youtube.com/channel/UCtUreqMG_C_P8Ymqa-LJ2Yg"
                            target="_blank"
                            title="Youtube"
                        >
                            <svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M16.4383 2.02465C16.246 1.31198 15.6797 0.750706 14.9605 0.56023C13.6571 0.214111 8.43038 0.214111 8.43038 0.214111C8.43038 0.214111 3.20371 0.214111 1.90022 0.56023C1.1811 0.750736 0.614732 1.31198 0.422503 2.02465C0.0732422 3.3164 0.0732422 6.01152 0.0732422 6.01152C0.0732422 6.01152 0.0732422 8.70663 0.422503 9.99839C0.614732 10.7111 1.1811 11.2489 1.90022 11.4394C3.20371 11.7855 8.43038 11.7855 8.43038 11.7855C8.43038 11.7855 13.6571 11.7855 14.9605 11.4394C15.6797 11.2489 16.246 10.7111 16.4383 9.99839C16.7875 8.70663 16.7875 6.01152 16.7875 6.01152C16.7875 6.01152 16.7875 3.3164 16.4383 2.02465ZM6.72096 8.45848V3.56455L11.0894 6.01158L6.72096 8.45848Z"
                                />
                            </svg>
                        </a>
                    </div>
