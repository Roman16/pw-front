...
const ConnectMws = ({onGoBackStep}) => {
    ...
    return (
        <section className='connect-mws-section'>
            ...
            <h4>Please note that you need to connect the primary account holder. Click <br/> button below to open the
                Seller Central.</h4>
            ...
            <div className="select-marketplace">
                ...
                <button className='btn default'>Get Credentials</button>
            </div>
    ...
    //             <h2>Account Sync.</h2>
    //             <p>We are syncing your data from Amazon Advertising API and MWS API. <br/>It could take up to a few minutes.</p>
    //
    //             <img src={loader} alt=""/>
    //         </div>
    //     </section>
