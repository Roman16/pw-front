...
const ProductItem = ({product, onSelect, isSelected, isOpened, onOpenVariations}) => {
    ...
    return (
        <>
            ...
            {product.variations && isOpened && <div className={`variations-list ${isSelected ? 'selected' : ''}`}>
                {product.variations.map(variationProduct => (
                    <div className={'variation-item'} onClick={() => onSelect(product, isSelected)}>
