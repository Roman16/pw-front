                ...
                <ul>
                    ...
                    {cogsList.map((item, index) => <>
                        <div
                            ...
                            <div className="value">{item.cogs_value && currencyWithCode(numberMask(item.cogs_value, 2))}</div>
                        </div>
                        ...
                        <li className={activeIndex === index && 'active'}>
                            ...
                            /> : <>
                                ...
                                <div className="value">{currencyWithCode(numberMask(item.cogs_value, 2))}</div>
