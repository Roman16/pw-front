                ...
                <div className='ant-popover-inner-content'>
                    ...
                    <div className="row">
                        ...
                        <div className="col values">
                            <div className="value">
                                {firstMetric.type === 'currency' ? currencyWithCode(payload[0].value) : (firstMetric.type === 'percent' ? `${payload[0].value} %` : payload[0].value)}
                            </div>

                            {secondMetric.key !== 'nothing' && <div className="value">
                                {secondMetric.type === 'currency' ? currencyWithCode(payload[1].value) : (secondMetric.type === 'percent' ? `${payload[0].value} %` : payload[0].value)}
                            </div>}
                        </div>
                    </div>
                </div>
