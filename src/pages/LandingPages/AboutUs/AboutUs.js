                        ...
                        <div className="inner">
                            <div className="text">
                                <div className="block-title">
                                    ...
                                    <p>
                                        Profit Whales is the team of passionate people who wants to deliver growth for our fellow
                                        clients.
                        ...
                        <div className="inner">
                            <div className="text">
                                <div className="block-title ta-left">
                                    ...
                                    <img src={greenLine} alt="title-line"/>
                                    <p>
                                        Our mission is to create Advertising across all platforms in just 1 Click. Just imagine
                                        you’ll be able to set up and launch advertising for your business in a few seconds. So
                                        everyone who has an idea will be able to promote it and scale with advertising without
