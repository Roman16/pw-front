...
const MainPage = () => {
    ...
    const [touchStart, swipeHandler] = useSwipeEffect(() => setActiveServicesSlide(prevState => prevState === 0 ? 3 : prevState - 1), () => setActiveServicesSlide(prevState => prevState === 3 ? 0 : prevState + 1))
    ...
    return (<div className="landing-page main-page">
        ...
        <section className="services">
            <div className="container">
                ...
                <ul className={'slider'} onTouchMove={swipeHandler} onTouchStart={touchStart}>
                    ...
                    <li className={activeServicesSlide === 3 && 'active'}>
                        <div className="header">
                            <i>
                                <svg width="60" height="48" viewBox="0 0 60 48" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <mask id="mask03" mask-type="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="60"
                                          height="48">
                                        <rect width="60" height="48" fill="#C4C4C4"/>
                                    </mask>
                                    <g mask="url(#mask03)">
                ...
                <div className="dots">
                    {[0,1,2,3].map(i => <div className={activeServicesSlide === i && 'active'} onClick={() => setActiveServicesSlide(i)}/>)}
                </div>
                    ...
                    <div className="col">
                        <Link to={'/enlighten-future'}>
                            ...
                            <svg width="34" height="24" viewBox="0 0 34 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <mask id="mask011" mask-type="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="34" height="24">
                                    <rect width="33.6" height="24" fill="#C4C4C4"/>
                                </mask>
                                <g mask="url(#mask011)">
                                    <path d="M22.1994 2.40003L31.1994 12M31.1994 12L22.1994 21.6M31.1994 12L2.39941 12" stroke="#6D6DF6" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                                </g>
                            </svg>
                        </Link>
