                ...
                {opened && <div className="account-links">
                    <div className="row">
                        ...
                        <div className={`account-status`}>
                            {account.amazon_mws.id && account.amazon_mws.status === 'IN_PROGRESS' && <span style={{color: '#f0b849'}}>In progress</span>}
                    ...
                    <div className="row">
                        ...
                        <div className={`account-status`}>
                            {account.amazon_ppc.id && account.amazon_ppc.status === 'IN_PROGRESS' && <span style={{color: '#f0b849'}}>In progress</span>}
