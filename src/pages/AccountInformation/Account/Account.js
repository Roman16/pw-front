      ...
      <div className="cabiner-card">
        ...
        <div className="connectors-box">
          <div className="connectors-title">
            ...
            <div className="sub">
              Certain Helium 10 tools require acess to third party services
              (such as Amazon Seller Central, Amazon Advertising or Facebook
              Marketing account). You can use the section below to grant or
              revoke access.
            </div>
          </div>
