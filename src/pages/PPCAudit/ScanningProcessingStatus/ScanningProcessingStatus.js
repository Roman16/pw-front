        ...
        return (<>
            <div className={'scanning-processing-status'}>
                <div className="col">
                    ...
                    {product.ppc_audit_indicator_state && product.ppc_audit_indicator_state.state === scanningStatusEnums.EXPIRED ?
                        <p className={'last-scan'}>
                            ...
                            Last scan: {moment(product.updated_at).format('DD MMM YYYY, HH:mm')} (Expired)
                        </p>
                        :
                        <p className={'last-scan'}>
                            Last scan: {moment(product.updated_at).format('DD MMM YYYY, HH:mm')}
                        </p>}
                </div>
