...
export const Header = ({
    ...
    const onChangeCompare = (date) => {
        setVisibleCompareDatePickerDropdown(false)
    ...
    return (
        <div className="header">
            ...
            <div className="date-pickers">
                ...
                <DatePicker
                    value={[selectedCompareDate?.startDate, selectedCompareDate?.endDate]}
                    onCalendarChange={onChangeCompare}
                    timeRange={(startDate) => onChangeCompare([startDate])}
                ...
                <div className="tz">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="#C9CBD4" stroke="#C9CBD4" stroke-width="0.4"/>
                    </svg>
                ...
                <div className="currency">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="#C9CBD4" stroke="#C9CBD4" stroke-width="0.5"/>
                        <path
...
const currentMarketplaceLabel = (marketplace) => <div
    className="current-timezone">{marketplace?.timezone && <>{marketplace?.timezone} (GMT {marketplaceTimezone(marketplace.timezone)})</>}</div>
